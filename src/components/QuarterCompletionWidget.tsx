...
export default function QuarterCompletionWidget({ quarterDate, quarterLabel }: Props) {
  ...
  // Use tracking records for fund report completion
  ...
  const items = [
    { label: `Fund Reports`, detail: fundReportDetail, done: fsComplete, warning: awaitingCount > 0 && !fsComplete ? `${awaitingCount} funds haven't reported` : undefined },
