  ...
  return (
    <>
      <TableRow className="table-row-hover cursor-pointer" onClick={onToggle}>
        ...
        <TableCell className="text-right font-mono">{fund.fund_name in (qData?.fundTVPIs || {}) ? (registryTvpi != null ? formatMultiple(registryTvpi) : '—') : (metrics.tvpi > 0 ? formatMultiple(metrics.tvpi) : '—')}</TableCell>
